...
│
├── tests/                      # pytest: 98 тестов (модульные + интеграционные)
...
> lightgbm 4.7.0, cryptography 50.0.1, watchdog 6.0 — 98/98 тестов проходят.
...
pytest -v                 # 98 тестов (сеть в тестах не нужна)
