...
│
├── tests/                      # pytest: 127 тестов (модульные + интеграционные)
...
> lightgbm 4.7.0, cryptography 50.0.1, watchdog 6.0 — 127/127 тестов проходят.
...
pytest -v                 # 127 тестов (сеть в тестах не нужна)
