...
│
├── tests/                      # pytest: 119 тестов (модульные + интеграционные)
...
> lightgbm 4.7.0, cryptography 50.0.1, watchdog 6.0 — 119/119 тестов проходят.
...
pytest -v                 # 119 тестов (сеть в тестах не нужна)
